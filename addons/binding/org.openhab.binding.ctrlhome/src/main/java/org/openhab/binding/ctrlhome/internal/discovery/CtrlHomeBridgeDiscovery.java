...
/**
 * The {@link CtrlHomeBridgeDiscovery} is responsible for discovering new MAX!
 * Cube LAN gateway devices on the network
 *
 * @author Marcel Verpaalen - Initial contribution
 *
 */
public class CtrlHomeBridgeDiscovery extends AbstractDiscoveryService {

    static final String MAXCUBE_DISCOVER_STRING = "eQ3Max*\0**********I";
    private final static int SEARCH_TIME = 15;

    private final Logger logger = LoggerFactory.getLogger(CtrlHomeBridgeDiscovery.class);
    ...
    public CtrlHomeBridgeDiscovery() {
        super(SEARCH_TIME);
    }
